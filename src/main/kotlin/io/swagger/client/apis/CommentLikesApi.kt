...
class CommentLikesApi(basePath: kotlin.String = "https://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun findAccountsLikedComment(id: java.math.BigDecimal, since: java.math.BigDecimal, offset: java.math.BigDecimal, count: java.math.BigDecimal) : kotlin.Array<Account> {
