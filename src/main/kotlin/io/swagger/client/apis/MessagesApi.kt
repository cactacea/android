...
class MessagesApi(basePath: kotlin.String = "https://localhost") : ApiClient(basePath) {
    ...
    * @return void
    */
    fun delete(body: DeleteMessagesBody) : Unit {
    ...
    */
    ...
    fun find(id: java.math.BigDecimal, ascending: kotlin.Boolean, since: java.math.BigDecimal, offset: java.math.BigDecimal, count: java.math.BigDecimal) : Message {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun post(body: PostMessageBody) : MessageCreated {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
