...
class InvitationsApi(basePath: kotlin.String = "https://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun createGroupInvitationToAccount(accountId: java.math.BigDecimal, groupId: java.math.BigDecimal) : InvitationCreated {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/accounts/{account_id}/groups/{group_id}/invitations".replace("{"+"account_id"+"}", "$accountId").replace("{"+"group_id"+"}", "$groupId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun createGroupInvitationToAccounts(id: java.math.BigDecimal, body: PostInvitationAccountsBody) : InvitationCreated {
