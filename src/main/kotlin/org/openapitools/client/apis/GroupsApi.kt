...
class GroupsApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    * @param privacyType Filters groups which can join in. (optional, default to null)
    * @param since Filters groups which started on since or later. (optional, default to null)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun findGroups(groupName: kotlin.String, invitationOnly: java.math.BigDecimal, privacyType: kotlin.String, since: java.math.BigDecimal, offset: java.math.BigDecimal, count: java.math.BigDecimal) : kotlin.Array<Group> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf("group_name" to listOf("$groupName"), "invitation_only" to listOf("$invitationOnly"), "privacy_type" to listOf("$privacyType"), "since" to listOf("$since"), "offset" to listOf("$offset"), "count" to listOf("$count"))
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/groups",
    ...
    */
    fun joinAccountToGroup(accountId: java.math.BigDecimal, groupId: java.math.BigDecimal) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/accounts/{account_id}/groups/{group_id}/join".replace("{"+"account_id"+"}", "$accountId").replace("{"+"group_id"+"}", "$groupId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<Any?>(
    ...
    */
    fun leaveAccountFromGroup(accountId: java.math.BigDecimal, groupId: java.math.BigDecimal) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/accounts/{account_id}/groups/{group_id}/leave".replace("{"+"account_id"+"}", "$accountId").replace("{"+"group_id"+"}", "$groupId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<Any?>(
