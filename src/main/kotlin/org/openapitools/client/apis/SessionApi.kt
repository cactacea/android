...
import io.github.cactacea.backend.GetSessionFriendsBody
...
class SessionApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun findSessionFriends(getSessionFriendsBody: GetSessionFriendsBody, since: java.math.BigDecimal, offset: java.math.BigDecimal, count: java.math.BigDecimal) : kotlin.Array<Account> {
        val localVariableBody: kotlin.Any? = getSessionFriendsBody
        val localVariableQuery: MultiValueMap = mapOf("since" to listOf("$since"), "offset" to listOf("$offset"), "count" to listOf("$count"))
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
